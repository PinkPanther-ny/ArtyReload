...
[Files]
Source: "D:\Code\ArtyReload\dist\Auto-Arty\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Code\ArtyReload\dist\Auto-Arty\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
